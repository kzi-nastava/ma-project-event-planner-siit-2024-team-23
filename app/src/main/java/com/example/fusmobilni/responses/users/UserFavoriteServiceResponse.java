...
public class UserFavoriteServiceResponse {
    private Long id;
    private String name;
    ...
    public UserFavoriteServiceResponse(Long id, String name, String description, Double price, String image, CategoryResponse category, LocationResponse location) {
        this.id = id;
        this.name = name;
