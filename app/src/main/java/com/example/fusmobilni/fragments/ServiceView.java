...
public class ServiceView extends Fragment implements DeleteServiceListener {
    ...
    public void addDummyData() {
        ...
        services.add(new PrototypeService("Beverages", "Hrana", "Jako dobra hrana", "Ovo je zaista jako specificno", 250, 25, true, true, 5, 1, 1, true, new ArrayList<>(), new ArrayList<>(Arrays.asList("SLavlje"))));
        ...
        services.add(new PrototypeService("Beverages", "Gulas", "Jako dobra hrana", "Ovo je zaista jako specificno", 250, 25, true, true, 5, 1, 1, true, new ArrayList<>(), new ArrayList<>(Arrays.asList("Svadba"))));
        services.add(new PrototypeService("Sport", "Fudbal", "Jako dobar sport", "Ovo je zaista jako specificno", 560, 25, false, false, 4, 2, 2, false, new ArrayList<>(), new ArrayList<>(Arrays.asList("Veselje"))));
    }
